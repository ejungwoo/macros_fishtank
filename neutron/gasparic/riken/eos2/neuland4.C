...
TCutG *protons_tpc, *deuterons_tpc, *tritons_tpc, *YvsXtpccut, *XvsZtpccut, *dyvsdxtpccut, *dyvsdztpccut, *TofvsMomcut;
TCutG *dedxvsetot;
void opencuts() {
  TFile *f = new TFile("helium.root");
  helium = (TCutG*)f->Get("CUTG");
  f->Close();
  f = new TFile("protonsA.root");
  ...
  f->Close();
  f = new TFile("dyvsdxcutA.root");
  dyvsdxtpccut = (TCutG*)f->Get("CUTG");
  f->Close();
  f = new TFile("dyvsdztpccut.root");
  dyvsdztpccut = (TCutG*)f->Get("CUTG");
  f->Close();
  f = new TFile("TofvsMomcut.root");
  TofvsMomcut = (TCutG*)f->Get("CUTG");
  f->Close();
  f = new TFile("dedxvsetotA.root");
  dedxvsetot = (TCutG*)f->Get("CUTG");
  f->Close();
}
...
TH1F* hJebote = new TH1F("hJebote","hjebote",1430000,0.5,1430000.5);
TH1F* hJebote2 = new TH1F("hJebote2","hjebote2",1430000,0.5,1430000.5);
TH1F* hJebote3 = new TH1F("hJebote3","hjebote3",1430000,0.5,1430000.5);
...
TH2F* hdxvsX0 = new TH2F("hdxvsX0","Tpc dx vs X 0",1000,-170.,170.,1000,-1000.,1000.);
TH2F* hdyvsY0 = new TH2F("hdyvsY0","Tpc dy vs Y 0",1000,-170.,170.,1000,-500.,500.);
...
TH2F* hdxvsXx = new TH2F("hdxvsXx","Tpc dx vs X x",1000,-170.,170.,1000,-1000.,1000.);
TH2F* hdyvsYx = new TH2F("hdyvsYx","Tpc dy vs Y x",1000,-170.,170.,1000,-500.,500.);

TH2F* hdyvsdx0 = new TH2F("hdyvsdx0","Tpc dy vs dx 0",1000,-1.2,1.2,1000,-1.2,1.2);
TH2F* hdyvsdz0 = new TH2F("hdyvsdz0","Tpc dy vs dz 0",1000,-1.2,1.2,1000,-1.2,1.2);
TH2F* hdxvsdz0 = new TH2F("hdxvsdz0","Tpc dx vs dz 0",1000,-1.2,1.2,1000,-1.2,1.2);
...
TH2F* hdyvsdxx = new TH2F("hdyvsdxnx","Tpc dy vs dx x",1000,-1.2,1.2,1000,-1.2,1.2);
TH2F* hdyvsdzx = new TH2F("hdyvsdznx","Tpc dy vs dz x",1000,-1.2,1.2,1000,-1.2,1.2);
TH2F* hdxvsdzx = new TH2F("hdxvsdznx","Tpc dx vs dz x",1000,-1.2,1.2,1000,-1.2,1.2);

TH2F* hdyvsdxm = new TH2F("hdyvsdxm","Tpc dy vs dx m",1000,-1.2,1.2,1000,-1.2,1.2);
TH2F* hdxvsdzm = new TH2F("hdxvsdzm","Tpc dx vs dz m",1000,-1.2,1.2,1000,-1.2,1.2);

TH2F* hvxz = new TH2F("hvxz","Vertex x vs z",500,-1000.,1000.,500,-500.,500.);
TH2F* hvxzc = new TH2F("hvxzc","Vertex x vs z c",500,-1000.,1000.,500,-500.,500.);
TH2F* hvyz = new TH2F("hvyz","Vertex y vs z",500,-1000.,1000.,500,-500.,500.);
TH2F* hvyzc = new TH2F("hvyzc","Vertex y vs z c",500,-1000.,1000.,500,-500.,500.);

TH2F* hdxvsMom0 = new TH2F("hdxvsmom0","Tpc dx vs mom 0",1000,0.,6000.,1000,-1.2,1.2);
TH2F* hdyvsMom0 = new TH2F("hdyvsmom0","Tpc dy vs mom 0",1000,0.,6000.,1000,-1.2,1.2);
TH2F* hdzvsMom0 = new TH2F("hdzvsmom0","Tpc dz vs mom 0",1000,0.,6000.,1000,-1.2,1.2);
TH2F* hdxvsMom = new TH2F("hdxvsmom","Tpc dx vs mom",1000,0.,6000.,1000,-1.2,1.2);
TH2F* hdyvsMom = new TH2F("hdyvsmom","Tpc dy vs mom",1000,0.,6000.,1000,-1.2,1.2);
TH2F* hdzvsMom = new TH2F("hdzvsmom","Tpc dz vs mom",1000,0.,6000.,1000,-1.2,1.2);
...
TH2F* hdxvsMomn = new TH2F("hdxvsmomn","Tpc dx vs mom n",1000,0.,6000.,1000,-1.2,1.2);
TH2F* hdyvsMomn = new TH2F("hdyvsmomn","Tpc dy vs mom n",1000,0.,6000.,1000,-1.2,1.2);
TH2F* hdzvsMomn = new TH2F("hdzvsmomn","Tpc dz vs mom n",1000,0.,6000.,1000,-1.2,1.2);

TH2F* hYvsXTpc0=new TH2F("hYvsXTpc0","Y vs X tpc 0",1000,-3000.,3000.,1000,-3000.,3000.);
TH2F* hYvsZTpc0=new TH2F("hYvsZTpc0","Y vs Z tpc 0",1000,-3000.,3000.,1000,-3000.,3000.);
TH2F* hXvsZTpc0=new TH2F("hXvsZTpc0","X vs Z tpc 0",1000,-3000.,3000.,1000,-3000.,3000.);
...
TH2F* hYvsXTpcx=new TH2F("hYvsXTpcx","Y vs X tpc x",1000,-3000.,3000.,1000,-3000.,3000.);
TH2F* hYvsZTpcx=new TH2F("hYvsZTpcx","Y vs Z tpc x",1000,-3000.,3000.,1000,-3000.,3000.);
TH2F* hXvsZTpcx=new TH2F("hXvsZTpcx","X vs Z tpc x",1000,-3000.,3000.,1000,-3000.,3000.);

TH2F* hYvsXTpcm=new TH2F("hYvsXTpcm","Y vs X tpc m",1000,-3000.,3000.,1000,-3000.,3000.);
TH2F* hXvsZTpcm=new TH2F("hXvsZTpcm","X vs Z tpc m",1000,-3000.,3000.,1000,-3000.,3000.);
...
TH1F* hDirTpcx=new TH1F("hDirTpcx","direction tpc x",720,-120.,120.);

TH1F* hDirTpcm=new TH1F("hDirTpcm","direction tpc m",720,-120.,120.);
...
TH2F* hTofvsMomn = new TH2F("hTofvsMomn","Tof vs Mom n",1000,-3000.,3000.,1000,0.,200.);
TH2F* hTofvsMomx = new TH2F("hTofvsMomx","Tof vs Mom x",1000,-3000.,3000.,1000,0.,200.);
...
TH2F* hDedxvsMom0 = new TH2F("hDedxvsMom0","dedx vs Mom 0",1000,-3000.,3000.,1000,0.,1000.);
TH2F* hDedxvsMom1 = new TH2F("hDedxvsMom1","dedx vs Mom 1",1000,-3000.,3000.,1000,0.,1000.);
...
TH2F* hDedxvsMomx = new TH2F("hDedxvsMomx","dedx vs Mom x",1000,-3000.,3000.,1000,0.,1000.);
...
TH1F* hTrmultall=new TH1F("hTrmultall","tpc mult all",150,-0.5,149.5);
TH1F* hTrmultvertex=new TH1F("hTrmultvertex","tpc mult vertex",150,-0.5,149.5);
TH1F* hTrmultcut=new TH1F("hTrmultcut","tpc mult cut",150,-0.5,149.5);
...
TH2F* hTofvsEhitClustNoVeto3 = new TH2F("hTofvsEhitClustNoVeto3","Tof vs Ehit charged 3",500,0.,1000.,3000,0.,300.);
TH2F* hTofvsEhitClustNoVeto4 = new TH2F("hTofvsEhitClustNoVeto4","Tof vs Ehit charged 4",500,0.,1000.,3000,0.,300.);
...
TH2F* hPlaneacut2[2*num_planes+1];
TH2F* hPlaneacut3[2*num_planes+1];
TH2F* hPlaneacut4[2*num_planes+1];
...
void loop(TChain *fChain, TChain *fChainx)
{
  ...
  for(int i=1;i<=2*num_planes;i++){
      ...
      sprintf(name1,"plane%iacut2",i);
      sprintf(name2,"Xhit vs Yhit clust %i 2",i);     
      hPlaneacut2[i] = new TH2F(name1,name2,680,-170,170,680,-170,170); 
      sprintf(name1,"plane%iacut3",i);
      sprintf(name2,"Xhit vs Yhit clust %i 3",i);     
      hPlaneacut3[i] = new TH2F(name1,name2,680,-170,170,680,-170,170); 
      sprintf(name1,"plane%iacut4",i);
      sprintf(name2,"Xhit vs Yhit clust %i 4",i);     
      hPlaneacut4[i] = new TH2F(name1,name2,680,-170,170,680,-170,170); 
  }
  for(int i=1;i<=8;i++){
 ...
 Int_t current_run2 = 0;
 Int_t current_event2 = 0;
 Int_t event_offset2 = 0;
 ...
 for (Long64_t jentry=0; jentry<nentries;jentry++) {
   ...
   Int_t tpc_tracks_cnt_all = 0;
   Int_t tpc_tracks_cnt_vertex = 0;
   Int_t tpc_tracks_cnt_cut = 0;

   Long64_t tpcentries = fChainx->GetEntries();

   fChainx->GetEvent(tpc0);
   current_event2 = eventid + event_offset2;
   current_run2 = run;
  
   for (int tpcentry=tpc0; tpcentry<tpcentries; tpcentry++) {
     
     fChainx->GetEvent(tpcentry);

     if (run != current_run2) {
       current_run2 = run;
       event_offset2 = current_event2;
     }

     current_event2 = eventid + event_offset2;

     if (jentry+1 == current_event2) {

       tpc_tracks_cnt_all++;
	
       if (sigma20z&&vz<-9.49569&&vz>-12.80121&&vx>-15&&vx<15&&vy<-206.06&&vy>-246.06&&parentvid==vid) {
   	 tpc_tracks_cnt_vertex++;
	 
	 hdyvsdx0->Fill(-1*dx, dy);
	 hdyvsdz0->Fill(dz, dy);

	 hYvsXTpc0->Fill(-1.*dx*mom, dy*mom);
	 hYvsZTpc0->Fill(dz*mom, dy*mom);
	 hXvsZTpc0->Fill(dz*mom, -1.*dx*mom);

	 hdxvsMom0->Fill(mom, -1.*dx);
	 hdyvsMom0->Fill(mom, dy);
	 hdzvsMom0->Fill(mom, dz);
	 
	 hDedxvsMom0->Fill(mom/charge,dedx);
	 
	 if (tpcdist<5.&&ndf>30&&abs(ea)<100) hDedxvsMom1->Fill(mom/charge,dedx);
     ...
     if (jentry+1 < current_event2) {
       ...
       //if ((float(jentry)/100.)==int(jentry/100)) {
       //	 cout << "event: " << jentry << " of " << current_event2 << endl;
       // }
       break;
     }
   }
   ...
   if (clno>0) {
     ...
     Int_t remember_tpc_cnt=0;
     Int_t remember_event_offset=0;
     totdetene=0.;
	 ...
	 if (in_veto==0) { // ############## NEUTRAL CLUSTERS ####################
	   ...
	   hJebote->Fill(jentry+1);

	   if (cclno==1) {
	     remember_tpc_cnt = tpc_cnt;
	     remember_event_offset = event_offset;
	     tpc_track_cnt = 0;
	   }
	   ...
	   if (jentry+1 < current_event) {
	     tpc_cnt = remember_tpc_cnt;
	     event_offset = remember_event_offset;
	     fChainx->GetEvent(tpc_cnt);
	     current_event = eventid + event_offset;
	     current_run = run;
	   }
	   ...
	   //if (jentry+1 == 9278)
	   //printf("%lld    %d    %d\n", jentry+1, current_event, tpc_cnt);
	   ...
	   Int_t first_tpc_track = 1;
	   Int_t first_tpc_trackc = 1;
	   Int_t first_tpc_trackn = 1;
	   
	   Int_t tpc_start = 0;
	   
	   if (jentry+1 == current_event ) tpc_start = 1;
	   ...
	   while (jentry+1 == current_event ) {
	     ...
	     if (mom!=0) {
	       //&&protons->IsInside(clusters[i].etot,clusters[i].tf)) {
	       
	       hdxvsdist->Fill(tpcdist, -1*dx*mom);
	       hdyvsdist->Fill(tpcdist, dy*mom);
	       
	       hdxvsX0->Fill(clusters[i].xf,-1.*mom*(-1*dx*cos(30./57.3)+dz*sin(30./57.3)));
	       hdyvsY0->Fill(clusters[i].yf,dy*mom);

	       if (sigma20z&&vz<-9.49569&&vz>-12.80121&&vx>-15&&vx<15&&vy<-206.06&&vy>-246.06
		   &&parentvid==vid) {
		 
		 //&&tpcdist<5.) { //&&ndf>30&&abs(ea)<100) {
		 
		 if (first_tpc_track == 1) {
		   hTofvsEhitClustNoVeto2->Fill(clusters[i].etot,clusters[i].tf);
		   hPlaneacut2[(cl_bar-1)/50+1]->Fill(clusters[i].xf,clusters[i].yf);
		   first_tpc_track = 0;
		 }
		 ...
		 hdyvsdxm->Fill(1*dx+0.02, dy);
		 hdxvsdzm->Fill(dz, 1*dx+0.02);
		 hYvsXTpcm->Fill(1.*(dx+0.02)*mom,dy*mom);
		 hXvsZTpcm->Fill(mom*dz,1.*mom*(dx+0.02));
		 hDirTpcm->Fill(atan2(1.*dx+0.02,dz)*57.3);
		 ...
		 hdxvsMom->Fill(mom, -1.*dx);
		 hdyvsMom->Fill(mom, dy);
		 hdzvsMom->Fill(mom, dz);
		 
		 //if (protons->IsInside(clusters[i].etot,clusters[i].tf)&&   // protons in NeuLAND + VETO
		 // protons_tpc->IsInside(mom/charge, dedx)) {                // protons in TPC
		 
		 //if (TofvsMomcut->IsInside(mom/charge,clusters[i].tf)) {    // protons correlation NL - TPC
		 
		 //if (dxvsXcut->IsInside(clusters[i].xf,(-1.*mom*(-1*dx*cos(30./57.3)+dz*sin(30./57.3))))
		 // &&dyvsYcut->IsInside(clusters[i].yf,dy*mom/charge)) {    // X and Y correlation NL - TPC
		 //}	 
		 
		 //if ((fabs(dy) < dx/5.&&-1*dx*mom<-300.   // ############# MAIN CONDITION so far ...
		   //  &&-1.*dx*mom<-0.5*dz*mom-210.&&-1.*dx*mom>-0.9*dz*mom-260.)&&
		   //(dxvsXcut->IsInside(clusters[i].xf,(-1.*mom*(-1*dx*cos(30./57.3)+dz*sin(30./57.3)))) 
		   // &&dyvsYcut->IsInside(clusters[i].yf,dy*mom/charge))) { // X and Y correlation NL - TPC
 
		 if (dx>0.5&&dx<0.85&&fabs(dy)<0.15) {   // dx  0.4 to 0.95    dy  -0.2 to 0.2
 
		   //protons_tpc->IsInside(mom/charge, dedx)) {          // protons in TPC
		   //if (dedxvsetot->IsInside(clusters[i].etot, dedx)&&  // protons correlation NL - TPC
		 
		   hdxvsMomc->Fill(mom, -1.*dx);
		   hdyvsMomc->Fill(mom, dy);
		   hdzvsMomc->Fill(mom, dz);
		   		   
		   //if (!(dyvsYcut->IsInside(clusters[i].yf,dy*mom))) {  // Y correlation NL - TPC
		   //if (!(dyvsdxtpccut->IsInside(-1.*dx, dy))) {   // strong gemetrical cut on dy - dx
		   if (!(dx>0.4&&dx<0.95&&fabs(dy)<0.2)) {
		   //if (!(fabs(dy) < dx/5.&&-1*dx*mom<-300.   // ############# MAIN CONDITION so far ...
		   //    &&-1.*dx*mom<-0.5*dz*mom-210.&&-1.*dx*mom>-0.9*dz*mom-260.)) {
		     ...
		     hdxvsMomn->Fill(mom, -1.*dx);
		     hdyvsMomn->Fill(mom, dy);
		     hdzvsMomn->Fill(mom, dz);
		     ...
		     hTofvsMomn->Fill(mom/charge,clusters[i].tf);

		     if (first_tpc_trackn == 1) {
		       hTofvsEhitClustNoVeto4->Fill(clusters[i].etot,clusters[i].tf);
		       hPlaneacut4[(cl_bar-1)/50+1]->Fill(clusters[i].xf,clusters[i].yf);
		       first_tpc_trackn = 0;
		     }
		   }
		   ...
		   if (first_tpc_trackc == 1) {
		     hTofvsEhitClustNoVeto3->Fill(clusters[i].etot,clusters[i].tf);
		     hPlaneacut3[(cl_bar-1)/50+1]->Fill(clusters[i].xf,clusters[i].yf);
		     first_tpc_trackc = 0;
		   }
		   ...
		   hDedxvsMomx->Fill(mom/charge, dedx);
		   hYvsXTpcx->Fill(-1.*mom*dx,mom*dy);
		   hYvsZTpcx->Fill(mom*dz,mom*dy);
		   hXvsZTpcx->Fill(mom*dz,-1.*mom*dx);
		   hdyvsdxx->Fill(-1*dx, dy);
		   hdyvsdzx->Fill(dz, dy);
		   hdxvsdzx->Fill(dz, -1*dx);
		   hDirTpcx->Fill(atan2(-1.*dx,dz)*57.3);
		   hdxvsXx->Fill(clusters[i].xf,-1.*mom*(-1*dx*cos(30./57.3)+dz*sin(30./57.3)));
		   hdyvsYx->Fill(clusters[i].yf,dy*mom);
		   hTofvsMomx->Fill(mom/charge,clusters[i].tf);
	   ...
	   if (first_tpc_track == 1 && tpc_start == 1) {
	   }
	   
	   if (cclno==1) hTrmult->Fill(tpc_track_cnt);
	   hJebote2->Fill(jentry+1, tpc_track_cnt);
   ...
   hJebote3->Fill(jentry+1,tpc_tracks_cnt_cut);
   ...
   hTrmultall->Fill(tpc_tracks_cnt_all);
   hTrmultvertex->Fill(tpc_tracks_cnt_vertex);
   hTrmultcut->Fill(tpc_tracks_cnt_cut);
   
   
   hNmultvsTrmult->Fill(tpc_tracks_cnt_vertex,nclno);
   hCmultvsTrmult->Fill(tpc_tracks_cnt_vertex,cclno);
   hVmultvsTrmult->Fill(tpc_tracks_cnt_vertex,vmult);
